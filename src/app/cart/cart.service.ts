...
import { IProduct, ProductsService } from '../products/products.service';
...
export class CartService {
  public cartItems: BehaviorSubject<IProduct[]> = new BehaviorSubject<IProduct[]>([]);
  ...
  public removeItemFromCart(prods: IProduct[], message: string) {
